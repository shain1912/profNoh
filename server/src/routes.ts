...
import type { ChatRequest, ImageRequest, LabRequest, CreateClassroomRequest, CreateClassroomResponse, GenerateDeckRequest, Deck } from '../../shared/types';
...
export async function registerRoutes(app: FastifyInstance) {
  ...
  app.get('/api/classrooms/:token', async (req) => {
    ...
    return { exists: true, title: c.title, status: c.status, anonymity: c.settings.anonymity, resultsReveal: c.settings.resultsReveal };
  });

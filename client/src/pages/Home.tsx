...
export default function Home() {
  return (
    <div className="mx-auto flex min-h-full max-w-xl flex-col items-center justify-center p-6 text-center">
      <div className="rounded-full bg-brand/10 px-4 py-1.5 text-sm font-bold tracking-widest text-brand">
        AI · AX 특강
      </div>
      <h1 className="mt-5 text-4xl font-extrabold leading-tight text-strong sm:text-5xl">
        AI와 나의 미래
      </h1>
